"""
Django settings for yellow_union_dev_101562 project.
...
ROOT_URLCONF = 'yellow_union_dev_101562.urls'
...
WSGI_APPLICATION = 'yellow_union_dev_101562.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_union_dev_101562 API",
    "DESCRIPTION": "API documentation for yellow_union_dev_101562 App",
    "VERSION": "v1",
}
